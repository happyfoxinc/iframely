...
export function getMediaEmbedWrapperHtml(oembedData) {
    ...
    return `<div ${maxWidth ? `style="max-width: ${maxWidth}"`: ''}><div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: ${paddingBottom}"><iframe allowfullscreen="" src="${CONFIG.baseAppUrl}/render?uri=${url}" style="top: 0; left: 0; width: 100%; height: 100%; position: absolute; border: 0;"></iframe></div></div>`
}